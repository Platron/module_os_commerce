 ...
 */
    ...
    public function install() {
      ...
      $data = array(array('title' => 'Enable Platron Payment Gate',
                          'key' => 'MODULE_PAYMENT_PLATRON_STATUS',
                          'value' => '-1',
                          'description' => 'Хотите ли вы принимать платежи через Platron?',
                          'group_id' => '6',
                          'use_function' => 'osc_cfg_use_get_boolean_value',
                          'set_function' => 'osc_cfg_set_boolean_value(array(1, -1))'),
                    array('title' => 'Идентификатор магазина в системе Platron',
                          'key' => 'MODULE_PAYMENT_PLATRON_MERCHANT_ID',
                          'value' => '',
                          'description' => 'Идентификатор магазина в системе Platron.',
                          'group_id' => '6'),
                    array('title' => 'Кодовое слово',
                          'key' => 'MODULE_PAYMENT_PLATRON_MERCHANT_SECRET_KEY',
                          'value' => '',
                          'description' => 'Секретный ключ магазина(см. в www.platron.ru/admin).',
                          'group_id' => '6'),
		  			array('title' => 'Action URL to Platron',
                          'key' => 'MODULE_PAYMENT_PLATRON_ACTION_URL',
                          'value' => 'http://www.platron.ru/payment.php',
                    ...
                    array('title' => 'Check URL',
                          ...
                          'description' => 'URL на который присылать check-запрос
							  (в случае пустого занчения, берется из настроек магазина на сайте Platron)',
                          'group_id' => '6'),
